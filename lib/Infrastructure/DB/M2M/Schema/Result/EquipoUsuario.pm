use utf8;
package Infrastructure::DB::M2M::Schema::Result::EquipoUsuario;
...
=head1 TABLE: C<equipo_usuario>

=cut

__PACKAGE__->table("equipo_usuario");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Pbk6jSAQo8zb0G8ZkXOAQw
